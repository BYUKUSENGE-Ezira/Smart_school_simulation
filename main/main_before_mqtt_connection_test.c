...
#define MQTT_STATUS_INTERVAL_MS 5000U
...
static void publish_mqtt_status_if_due(void)
{
    ...
    mqtt_alarm_status_t mqtt_status = {
        .auto_enabled =
...
void app_main(void)
{
    ...
    esp_err_t mqtt_start_result =
         ...
         * MQTT temporarily disabled while diagnosing the
         * Wokwi connection reset.
         */
...
while (1)
    {
         ...
         */
        /*
         * MQTT publishing temporarily disabled.
         */
