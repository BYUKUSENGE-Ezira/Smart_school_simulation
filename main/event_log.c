...
)
{
    ...
    if (type < EVENT_LOG_SYSTEM_START ||
        type > EVENT_LOG_ADMIN_PIN_CHANGED)
    {
...
)
{
    switch (type)
    {
        ...
        case EVENT_LOG_POWER_ON_RESET:
            return "POWER ON RESET";

        case EVENT_LOG_SOFTWARE_RESET:
            return "SOFTWARE RESET";

        case EVENT_LOG_WATCHDOG_RESET:
            return "WATCHDOG RESET";

        case EVENT_LOG_BROWNOUT_RESET:
            return "BROWNOUT RESET";

        case EVENT_LOG_PANIC_RESET:
            return "PANIC RESET";

        case EVENT_LOG_EXTERNAL_RESET:
            return "EXTERNAL RESET";

        case EVENT_LOG_DEEP_SLEEP_WAKE:
            return "DEEP SLEEP WAKE";

        case EVENT_LOG_UNKNOWN_RESET:
        ...
        case EVENT_LOG_TIME_FORWARD_JUMP:
            return "TIME FORWARD JUMP";

        case EVENT_LOG_TIME_BACKWARD_JUMP:
            return "TIME BACKWARD JUMP";

        case EVENT_LOG_ADMIN_LOGIN_GRANTED:
            return "ADMIN LOGIN OK";

        case EVENT_LOG_ADMIN_LOGIN_FAILED:
            return "ADMIN LOGIN FAILED";

        case EVENT_LOG_ADMIN_LOCKED:
            return "ADMIN LOCKED";

        case EVENT_LOG_ADMIN_PIN_CHANGED:
            return "ADMIN PIN CHANGED";

        case EVENT_LOG_ANNOUNCEMENT_LIVE_STARTED:
            return "LIVE ANN STARTED";

        case EVENT_LOG_ANNOUNCEMENT_LIVE_STOPPED:
            return "LIVE ANN STOPPED";

        case EVENT_LOG_ANNOUNCEMENT_EMERGENCY_STARTED:
            return "EMERGENCY STARTED";

        case EVENT_LOG_ANNOUNCEMENT_EMERGENCY_STOPPED:
